...
export default function BusinessChatroomUpdateForm(props) {
  const {
    id: idProp,
    businessChatroom,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = businessChatroomRecord
      ? { ...initialValues, ...businessChatroomRecord }
      : initialValues;
  ...
  const [businessChatroomRecord, setBusinessChatroomRecord] =
    React.useState(businessChatroom);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(BusinessChatroom, idProp)
        : businessChatroom;
      setBusinessChatroomRecord(record);
    };
    queryData();
  }, [idProp, businessChatroom]);
  React.useEffect(resetStateValues, [businessChatroomRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            BusinessChatroom.copyOf(businessChatroomRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "BusinessChatroomUpdateForm")}
      {...rest}
    >
      <ArrayField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || businessChatroom)}
